<?php include('inc/header.php'); ?>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 highlight">
					...
					<div class="h-body">
						<p>
							A stronger community begins with helping at-risk students change their
							story. At Learn4Life, we provide personalized education and support— 
							to eliminate all obstacles in the way of a high school diploma. Every
							dropout we save represents the key to creating safer, more prosperous 
					...
					<div class="col-md-6 col-sm-6 highlight">
						...
						<div class="h-body">
							<p>
								...
								Daniel didn't have enough
								to eat. School was last on
								the list of priorities, and
				...
				<div class="col-md-8 col-sm-6 highlight">
					...
					<h4><B>CHANGING THEIR STORIES</B></h4>
					<div class="h-body">
						<p>
							Meet our students and faculty and see how we're impacting the communities we serve.
						</p>
					</div>
				</div>
			</div> <!-- /row  -->
